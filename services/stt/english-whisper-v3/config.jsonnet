...

{
  ...
  //Traefik
  traefik_endpoint: '/stt-english-whisper-v3',
  traefik_strip_prefix: '/stt-english-whisper-v3',
  ...
  gateway_server_desc:{ en: "LinTO English – Whisper large model v3",fr:"LinTO Anglais– Modèle whisper v3"},
  gateway_server_scope: 'cm,api,stt',

  gateway_define_endpoints: [
    {
      endpoint: 'stt-english-whisper-v3',
